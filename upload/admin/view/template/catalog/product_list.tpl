        ...
        <div class="well">
          <div class="row">
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-category"><?php echo $entry_category_one; ?></label>
                <input type="text" name="filter_category" value="<?php echo $filter_category; ?>" placeholder="<?php echo $entry_category_one; ?>" id="input-category" class="form-control" />
              </div>
